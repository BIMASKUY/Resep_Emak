...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM savedrecipe JOIN listrecipe ON savedrecipe.id = listrecipe.id WHERE listrecipe.recipe_title ILIKE '%$searchTerm%' AND savedrecipe.username = '$user_now';";
    ...
    $query = "SELECT * FROM savedrecipe JOIN listrecipe ON savedrecipe.id = listrecipe.id WHERE savedrecipe.username = '$user_now';";
    $result = pg_query($db, $query);
...
<head>
    ...
    <link href="savedrecipe.css" rel="stylesheet">
</head>
    <body>
        <div class="container"> <!-- HEADER CONTAINER -->
            <div class="header">
                ...
                <div class="hero">
                    <span class="nohighlight1">MY</span> <span class="nohighlight2">BOOKMARKS</span> <span class="highlight">RECIPES.</span>
                </div>
