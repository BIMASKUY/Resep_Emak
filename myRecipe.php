...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT id, recipe_title, url_foto, created_user FROM listrecipe WHERE recipe_title ILIKE '%$searchTerm%' AND created_user = '$user_now'";
    ...
    $query = "SELECT id, recipe_title, url_foto, created_user FROM listrecipe WHERE created_user = '$user_now'";
    $result = pg_query($db, $query);
                ...
                <div class="container4"> <!-- RECIPES CONTAINER -->
                    <?php
                        ...
                        while ($row = pg_fetch_assoc($result)) {
                            echo '<a href="openMyRecipe.php?recipe_id=' . urlencode($row["id"]) . '">
                                    <div class="recipes">
