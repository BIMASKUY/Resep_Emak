...
$_SESSION["url_foto_now"] = 'default_foto_profile.png';
        ...
        <div class="desktop">
          <div class="overlap-group">
            ...
            <div class="search">
              <div class="text-wrapper-2">
                <a href="listRecipe.php" class="akun-1"> Discover More Recipes</a>
              </div>
            </div>
            <div class="overlap-3">
          ...
          <div class="overlap-5">
            ...
            <div class="div-wrapper">
              <div class="text-wrapper-9"><a href="login.php" class="akun">Log In</a></div>
            </div>
            <div class="search-2">
              <div class="text-wrapper-9"><a href="signUp.php" class="akun" >Sign Up </a></div>
            </div>
          </div>
        </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    <?php else : ?>
      if (window.location.hash === "#scrollToBottom") {
        window.location.href = "indexLogin.php#scrollToBottom";
      }
    <?php endif; ?>
  });
  ...
  document.addEventListener("DOMContentLoaded", function () {
      ...
      const footer = document.querySelector(".rectangle-2");
